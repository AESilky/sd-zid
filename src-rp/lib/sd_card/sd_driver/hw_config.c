...
*/
/*
Modified by AES for use in this board/source, 2023/25.
*/
...
static spi_t spis[] = {  // One for each SPI.
    {
        .hw_inst = SPI_SD_DEVICE,      // SPI component
        .miso_gpio = SPI_SD_MISO,      // GPIO number (not pin number)
        .mosi_gpio = SPI_SD_MOSI,
        .sck_gpio = SPI_SD_SCK,
        ...
        .initSPI = false,
        .baud_rate = SPI_SD_SPEED,   // See system_def.h.
