/**
 * @brief Debugging Hard-Fault Handler.
 * @ingroup debug
 *
 * Link in to provide debugging information about Hard-Faults.
 * This may interfere with some 'normal' optionations, so it's best to
 * only link it in when trying to debug a problem.
 *
